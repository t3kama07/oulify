...
const legalPages = {
  en: {
    ...
    privacyPolicy: {
      ...
      metaDescription:
        "Lue, miten Oulify kerää, käyttää, säilyttää ja suojaa henkilötietoja, joita jaetaan verkkosivuston ja projektitiedustelujen kautta.",
      title: "Tietosuojaseloste",
      intro:
        "Tämä tietosuojaseloste kertoo, miten Oulify kerää, käyttää, säilyttää ja suojaa tietoja, joita jaetaan tämän verkkosivuston kautta ja projektikeskustelujen aikana.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            "Keräämme tietoja, jotka päätät jakaa meille, kun otat yhteyttä Oulifyyn verkkosivu-, sovellus-, automaatio-, markkinointi- tai videoprojektia varten.",
          ],
          items: [
            "Yhteystiedot, kuten nimi, sähköpostiosoite ja yrityksen nimi.",
            "Projektitiedot, kuten tavoitteet, aikataulu, budjettia koskevat huomiot ja viestin sisältö.",
            "Viestintähistoria, kun otat yhteyttä sähköpostilla, WhatsAppilla tai muilla sovituilla kanavilla.",
            "Perustason tekniset käyttötiedot, joita hosting-ympäristö tai sivuston suorituskykytyökalut voivat kerätä, kuten selain, laite ja sivujen käyttö.",
          ],
        },
        {
          title: "Miten käytämme tietoja",
          paragraphs: [
            "Käytämme kerättyjä tietoja sivuston ylläpitoon ja palvelujen toimittamiseen vastuullisesti.",
          ],
          items: [
            "Vastaamme yhteydenottoihin ja laadimme tarjouksia tai projektisuosituksia.",
            "Hallinnoimme asiakasviestintää, projektitoimituksia, laskutusta ja tukea.",
            "Parannamme verkkosivustoa, palveluja ja palvelun laatua.",
            "Suojaamme sivustoa, estämme väärinkäyttöä ja täytämme lakisääteiset tai sopimuksiin liittyvät velvoitteet.",
          ],
        },
        {
          title: "Tietojen jakaminen",
          paragraphs: [
            "Emme myy henkilötietoja. Jaamme tietoja vain silloin, kun se on tarpeen liiketoiminnan pyörittämiseen tai palvelujen toimittamiseen.",
          ],
          items: [
            "Luotettujen palveluntarjoajien kanssa, kuten hosting-, sähköposti-, tiedostonsäilytys-, viestintä- tai maksutyökalujen osalta.",
            "Viranomaisten kanssa silloin, kun laki niin vaatii.",
            "Projektikumppaneiden tai alihankkijoiden kanssa vain silloin, kun he tarvitsevat tietoja sovitun työn toteuttamiseen.",
          ],
        },
        {
          title: "Tietojen säilytys ja suojaus",
          paragraphs: [
            "Säilytämme henkilötietoja vain niin kauan kuin se on kohtuullisesti tarpeen viestintää, projektitoimituksia, kirjanpitoa tai lakisääteisiä velvoitteita varten.",
            "Käytämme kohtuullisia teknisiä ja organisatorisia suojaustoimia, mutta mikään verkkosivusto tai verkkotallennusratkaisu ei voi taata täydellistä turvallisuutta.",
          ],
        },
        {
          title: "Oikeutesi",
          paragraphs: [
            "Sijainnistasi riippuen sinulla voi olla oikeus pyytää pääsyä tietoihisi sekä tietojen oikaisua tai poistamista.",
          ],
          items: [
            "Voit pyytää kopion tiedoista, joita säilytämme sinusta.",
            "Voit pyytää virheellisten tai vanhentuneiden tietojen korjaamista.",
            "Voit pyytää tietojen poistamista, jos emme enää tarvitse niitä.",
            "Voit peruuttaa suostumuksen valinnaiseen viestintään silloin, kun käsittely perustuu suostumukseen.",
          ],
        },
        {
          title: "Yhteys",
          paragraphs: [
            "Jos sinulla on tietosuojaan liittyviä kysymyksiä tai haluat tehdä tietopyynnön, ota yhteyttä osoitteeseen hello@oulify.com.",
          ],
        },
      ],
    },
    termsAndConditions: {
      slug: "terms-and-conditions",
      metaTitle: "Käyttöehdot | Oulify",
      metaDescription:
        "Tutustu yleisiin ehtoihin, joita sovelletaan Oulifyn verkkosivuston käyttöön sekä verkkosivu-, sovellus-, automaatio- ja muihin digipalveluprojekteihin.",
      title: "Käyttöehdot",
      intro:
        "Nämä käyttöehdot kuvaavat yleiset säännöt Oulifyn verkkosivuston käytölle ja yhteistyölle Oulifyn kanssa digipalveluprojekteissa.",
      effectiveDateLabel: "Voimassa alkaen",
      effectiveDate: "1.4.2026",
      sections: [
        {
          ...
          paragraphs: [
            "Käyttämällä tätä verkkosivustoa sitoudut käyttämään sitä lainmukaisesti ja asiallisesti. Et saa käyttää sivustoa tavalla, joka vahingoittaa sivustoa, yrittää luvattomasti päästä järjestelmiin tai häiritsee sivuston normaalia toimintaa.",
          ],
        },
        {
          title: "Palvelut ja projektin laajuus",
          paragraphs: [
            "Oulify tarjoaa digitaalisia palveluja, kuten verkkosivuja, laskeutumissivuja, mobiilisovelluksia, automaatiojärjestelmiä, kasvun tukipalveluja sekä tuote- ja demovideoita.",
            "Jokaiseen maksulliseen projektiin sovelletaan erikseen kirjallisesti sovittuja tarjousta, laajuutta, aikataulua ja toimitussisältöä koskevia ehtoja.",
          ],
        },
        {
          title: "Asiakkaan vastuut",
          paragraphs: [
            "Jotta työ etenee sujuvasti, asiakkaan tulee toimittaa palaute, sisällöt, hyväksynnät, tunnukset ja muut tarvittavat pääsyoikeudet ajallaan.",
        ...
        },
        {
          ...
          paragraphs: [
            "Hinnoittelu, mahdolliset ennakkomaksut, välimaksut ja sisältyvät muutoskierrokset määritellään sovitussa tarjouksessa tai laskussa.",
            "Sovitun laajuuden ulkopuolinen työ voidaan hinnoitella erikseen.",
            "Jos maksu on myöhässä, Oulifylla on oikeus keskeyttää käynnissä oleva työ, kunnes avoin saldo on maksettu.",
          ],
        },
        {
          title: "Omistusoikeus ja portfoliokäyttö",
          paragraphs: [
            "Ellei kirjallisesti toisin sovita, asiakas saa oikeudet lopullisiin hyväksyttyihin toimituksiin sen jälkeen, kun kaikki sovitut maksut on maksettu kokonaisuudessaan.",
            "Oulify säilyttää oikeudet olemassa oleviin työkaluihin, uudelleenkäytettäviin runkoihin, sisäisiin prosesseihin ja kolmannen osapuolen aineistoihin, joihin sovelletaan erillisiä lisenssejä.",
            "Ellei kirjallista salassapitoa ole sovittu, Oulify voi esitellä valmistunutta työtä portfoliossa tai markkinointimateriaaleissa.",
          ],
        },
        {
          title: "Vastuunrajoitus",
          paragraphs: [
            "Oulify pyrkii toimittamaan laadukasta työtä, mutta emme takaa tiettyjä liiketoimintatuloksia, hakukonesijoituksia, alustojen käytettävyyttä tai kolmannen osapuolen palveluiden keskeytyksetöntä toimintaa.",
            ...
            "Näitä ehtoja tulkitaan yhdessä kyseistä palvelua varten toimitetun kirjallisen sopimuksen, tarjouksen tai laskun kanssa, ellei kirjallisesti toisin sovita.",
          ],
        },
      ],
    },
    refundPolicy: {
      slug: "refund-policy",
      metaTitle: "Palautuskäytäntö | Oulify",
      metaDescription:
        "Lue, miten Oulify käsittelee hyvityksiä ja palautuksia mukautetuissa digipalveluissa, mukaan lukien ennakkomaksut, välivaiheet ja projektin peruutukset.",
      title: "Palautuskäytäntö",
      intro:
        "Tämä palautuskäytäntö kertoo, miten Oulify käsittelee hyvityksiä ja palautuksia mukautetuissa digipalveluissa, kuten verkkosivu-, sovellus- ja automaatioprojekteissa.",
      effectiveDateLabel: "Voimassa alkaen",
      effectiveDate: "1.4.2026",
      sections: [
        {
          ...
          paragraphs: [
            "Useimmat Oulifyn palvelut ovat asiakkaalle erikseen toteutettavia ja aikaan perustuvia. Siksi mahdolliset palautukset arvioidaan tehdyn työn, varatun ajan ja projektin vaiheen perusteella.",
          ],
        },
        {
          title: "Ennen työn alkamista",
          paragraphs: [
            "Jos projekti perutaan ennen työn alkamista, Oulify voi palauttaa ennakkoon maksettuja summia vähennettynä mahdollisilla suunnittelu-, konsultointi-, maksunkäsittely- tai varauskuluilla, joita on jo syntynyt.",
          ],
        },
        {
          title: "Kun työ on alkanut",
          paragraphs: [
            "Kun strategia-, suunnittelu-, kehitys-, editointi-, asennus- tai tuotantotyö on alkanut, valmistunutta työtä vastaavat maksut eivät ole palautuskelpoisia.",
            "Projektien ennakkomaksut ovat yleensä palautuskelvottomia kickoffin tai ensimmäisen aktiivisen työvaiheen jälkeen.",
          ],
        },
        {
          title: "Välivaiheet ja jatkuvat palvelut",
          paragraphs: [
            "Hyväksytyt välivaiheet, toimitettu työ ja toteutuneet palvelujaksot eivät ole palautuskelpoisia.",
            "Jos projektiin sisältyy kuukausittaista jatkuvaa työtä, peruutus koskee tulevia maksamattomia jaksoja eikä hyvitä jo tehtyä tai käynnissä olevaa laskutusjaksoa.",
          ],
        },
        {
          title: "Jos toimituksessa on ongelma",
          paragraphs: [
            "Jos Oulify ei selkeästi pysty toimittamaan sovittua laajuutta syystä, joka on hallinnassamme, pyrimme ensisijaisesti korjaamaan tilanteen kohtuullisessa ajassa.",
            "Jos se ei ole mahdollista, voimme tarjota suhteellisen osittaisen hyvityksen, krediitin tai muun reilun kirjallisesti sovitun ratkaisun keskeneräisen osuuden perusteella.",
          ],
        },
        {
          title: "Miten pyydät palautusarviota",
          paragraphs: [
            "Voit pyytää palautusarviota lähettämällä sähköpostia osoitteeseen hello@oulify.com ja kertomalla projektin nimen, laskutiedot ja pyynnön syyn.",
            "Käsittelemme pyynnöt hyvän tavan mukaisesti ja vastaamme niin nopeasti kuin kohtuudella mahdollista.",
          ],
        },
      ],
    },
...
export function buildLegalMetadata({ locale, dict, pageKey }) {
  ...
  const canonicalPath = getLocalizedPath(locale, `/${legalPage.slug}`);
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: getLocalizedPath("en", `/${legalPage.slug}`),
        fi: getLocalizedPath("fi", `/${legalPage.slug}`),
        "x-default": getLocalizedPath(defaultLocale, `/${legalPage.slug}`),
      },
    },
    openGraph: {
      url: canonicalPath,
